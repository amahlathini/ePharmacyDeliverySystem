...
//private String baseURL = "http://localhost:8080/contacts/";
//
//
//@Order(1)
//    @Test
...
//        assertEquals(contactInformation.getContact_id(), postResponse.getBody().getContact_id());
//
//    }
//
//    @Order(2)
...
//    void read() {
//
//        String url = baseURL + "read/" + contactInformation.getContact_id();
//        System.out.println("URL: " + url);
//        ResponseEntity<ContactInformation> response = restTemplate
//                .withBasicAuth(Security_UserName,Security_Password)
//                .getForEntity(url,ContactInformation.class);
//        assertEquals(contactInformation.getContact_id(), response.getBody().getContact_id());
//    }
//
//    @Order(3)
//    @Test
//    void update() {
//
//        ContactInformation updated = new ContactInformation.Builder().copy(contactInformation).setPrimary_number("084955588").build();
...
//    void delete() {
//
//        String url = baseURL + "delete/" + contactInformation.getContact_id();
//        System.out.println("URL " + url);
