...
//    private String baseURL = "http://localhost:8080/history/";
//
//    @Order(1)
//    @Test
...
//        assertEquals(orderHistory.getTotal_number_of_orders(), postResponse.getBody().getTotal_number_of_orders());
//
//    }
//
//    @Order(2)
//    @Test
//    public void b_read() {
//        String url = baseURL + "read/" + orderHistory.getUser().getUser_id();
//        System.out.println("URL: " + url);
//        ResponseEntity<OrderHistory> response = restTemplate
//                .withBasicAuth(USERNAME, USER_PASSWORD)
//                .getForEntity(url, OrderHistory.class);
//        assertEquals(orderHistory.getTotal_order_value().doubleValue(), response.getBody().getTotal_order_value().doubleValue());
//    }
//
//    @Order(3)
//    @Test
//    public void c_update() {
//        OrderHistory updatedOrderHistory = new OrderHistory.Builder().copy(orderHistory).setTotal_number_of_orders(7000).build();
...
//        assertEquals(orderHistory.getUser().getUser_id(), response.getBody().getUser().getUser_id());
//    }
//
//    @Order(5)
//    @Test
//    public void e_delete() {
//        String url = baseURL + "delete/" + orderHistory.getUser().getUser_id();
//        System.out.println("URL: " + url);
